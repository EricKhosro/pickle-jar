...
export const darkTheme = {
  ...
  colors: {
    ...
    selection: brand.indigoLight,
    onSelection: brand.white,
...
export const lightTheme = {
  ...
  colors: {
    background: "#e7e3f7",
    backgroundDeep: "#d8d3f0",
    surface: "#f2eefc",
    surfaceRaised: "#cbc4ee",
    featureArt: "#e0d9f4",
    card: "#ffffff",
    text: brand.indigo,
    textMuted: "rgba(60, 60, 169, 0.72)",
    primary: brand.orange,
    primaryHover: brand.orangeHover,
